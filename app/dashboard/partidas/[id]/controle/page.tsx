    ...
    <main className="flex-1 p-4 sm:p-6 lg:p-8">
      <div className="mx-auto w-full max-w-7xl">
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-slate-500">Progresso da partida</p>
            ...
            <div className="border-b border-slate-200 px-6 py-5">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="rounded-lg bg-slate-100 px-4 py-2 text-center">
                  ...
                  <p className="text-2xl font-bold tabular-nums">{tempo}s</p>
                </div>
              </div>
            </div>
                ...
                {pergunta.alternativas.map((alternativa, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium">{alternativa}</span>
                    </div>
                  </button>
                ))}
              </div>
