                ...
                <div className="space-y-6 lg:col-span-2">
                    ...
                    <div className="space-y-5 p-5 sm:p-6">
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-xs text-slate-500">
                          O vídeo ou imagem será utilizado na tela de
                          apresentação durante a partida.
                        </p>
                      </div>
                    </div>
                  </section>
                  ...
                  <section className="rounded-xl border border-slate-200 bg-white shadow-sm">
                    <div className="border-b border-slate-200 px-5 py-4 sm:px-6 sm:py-5">
                      ...
                      <p className="mt-1 text-sm text-slate-500">
                        Defina como as perguntas serão selecionadas durante a
                        partida.
                      </p>
                    </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <label className="flex cursor-pointer items-center justify-between rounded-lg border border-slate-200 p-4">
                            <div>
                              ...
                              <p className="text-xs text-slate-500">
                                Disponibiliza a explicação didática após a
                                resposta.
                              </p>
                            </div>
