      ...
      <div className="relative z-10 w-full max-w-6xl text-center">
        ...
        {onJogarNovamente && (
          <button
            type="button"
            onClick={onJogarNovamente}
            className="mt-8 inline-flex items-center gap-2 rounded-xl bg-white px-7 py-4 text-sm font-black text-slate-950 transition hover:scale-105 hover:bg-slate-100"
          >
            <RotateCcw size={18} />
            Jogar novamente
          </button>
